# T0024 Provider Compatibility Repair v0.2.1

`PROVIDER_COMPAT_REPAIR=PASS_LOCAL`. Strict Structured Outputs schema compatibility, trusted per-agent call budgeting, AbortController timeout handling, and process IPC regression were verified locally. `REAL_MODEL_CALL_COUNT=0`; no provider preflight or live experiment was run.
